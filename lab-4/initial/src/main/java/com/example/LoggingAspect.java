...
public class LoggingAspect {
  ...
  @After(value = "execution(* com.example.beans.MyBeanOne.operationOne(..)) && args(msg)", argNames = "msg")
  public void logAfterBeanOne(String msg) {
      Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
      logger.trace("After 'MyBeanOne.operationOne('" + msg + "')'");
  }

  @AfterReturning(value = "execution(* com.example.beans.MyBeanOne.operationOne(..)) && args(msg)", argNames = "msg")
